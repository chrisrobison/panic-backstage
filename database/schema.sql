-- ============================================================================
-- Panic Backstage — canonical database schema (single source of truth)
-- ============================================================================
--
-- This file is the COMPLETE schema for a fresh database. It is generated by
-- dumping the live MySQL schema (structure only) and is the baseline that all
-- prior numbered migrations have been squashed into.
--
-- Regenerate after schema changes:
--   see "Database schema & migrations" in README.md
--
-- Conventions:
--   * Tables use CREATE TABLE IF NOT EXISTS so applying this file is safe and
--     non-destructive against an existing database.
--   * Incremental changes after this baseline live in database/migrations/ and
--     are applied with scripts/migrate.php (tracked in schema_migrations).
-- ============================================================================
...
-- Target database. seed.php connects without a default database and relies on
-- this; the app and scripts/migrate.php connect with DB_NAME already selected,
-- where CREATE DATABASE/USE are harmless no-ops.
...
-- ----------------------------------------------------------------------------
-- Panic Promote — marketing campaign module (migration 006)
-- ----------------------------------------------------------------------------
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
-- ----------------------------------------------------------------------------
-- schema_migrations — ledger of applied incremental migrations.
-- Populated by scripts/migrate.php. Empty on a fresh install built from this
-- baseline; every migration in database/migrations/ that is not yet recorded
-- here is applied (in filename order) and then stamped.
-- ----------------------------------------------------------------------------
