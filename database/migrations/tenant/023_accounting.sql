-- ── tenant/023: Accounting integration framework ─────────────────────────────
-- Per-tenant chart of accounts mapping, sync log, and provider settings.
-- Mirrors 035_accounting.sql for the main DB; applied to every tenant DB.
