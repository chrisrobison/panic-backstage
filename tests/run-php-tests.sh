...
TESTS_DIR="./tests"
DB_TESTS=("rate_limiter_test.php" "process_versions_test.php" "process_runtime_test.php" "process_centerstage_handlers_test.php" "ai_phase2_db_test.php" "leads_thread_matcher_test.php" "leads_acknowledgment_test.php" "leads_claim_service_test.php" "leads_classifier_test.php" "leads_claim_service_db_test.php" "leads_onboarding_db_test.php" "leads_classification_correction_db_test.php" "booking_inbox_role_scope_db_test.php" "booking_inbox_quarantine_db_test.php" "booking_inbox_attachment_delivery_db_test.php" "room_conflict_guard_db_test.php" "door_sale_db_test.php" "manual_admit_db_test.php" "payment_financials_db_test.php" "push_subscriptions_db_test.php" "ticket_audience_series_db_test.php" "contract_details_gate_test.php" "event_owner_guard_db_test.php" "events_clone_db_test.php" "contract_series_share_db_test.php" "realtime_stream_db_test.php" "public_event_page_db_test.php" "opportunities_module_db_test.php" "opportunities_dashboard_db_test.php" "opportunities_conferences_db_test.php" "opportunities_companies_db_test.php" "opportunities_pipeline_db_test.php" "opportunities_notes_workspace_db_test.php" "opportunities_research_db_test.php" "opportunities_phase8_db_test.php")
