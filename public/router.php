...
if (str_starts_with($path, '/api/') || $path === '/t' || str_starts_with($path, '/t/') || $path === '/e' || str_starts_with($path, '/e/') || $path === '/assets/qr.svg' || $path === '/assets/qr.png' || preg_match('#^/feeds/public-events\.(ics|rss|json)$#', $path)) {
