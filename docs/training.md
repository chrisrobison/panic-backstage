...
## Module 3 — Night-Of Workflows (30 min)
...
## Module 4 — Roles & Permissions (15 min)
...
| Role | Can do |
|---|---|
| **Venue Admin** | Everything — settings, users, templates, settlement |
| **Booker** | Create/edit events, manage contracts |
| **Manager** | Edit events, run sheets, day-of ops |
...
## Module 5 — Post-Event & Settlement (20 min)
...
## Module 6 — Q&A + Reference Resources (20 min)

### Where to Get Help
- **Ops Manual** — `[your-domain]/docs/ops-manual.html` — full reference, bookmark it
- **The activity log** on any event — shows who did what and when
- **Admin contact:** [your name / email]

### What We're NOT Covering Today
Let trainees know these exist for later:
- **Panic Promote** — the multi-channel social media tool (Chapter 4 in ops manual)
