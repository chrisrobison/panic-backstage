...
- **Added** `opportunities` — Phase 7 — Claude CLI research (WebSearch/WebFetch) jobs
- **Added** `opportunities` — Phase 6 — First-class Research Notes workspace
...
- **Documentation** — Add project-root CLAUDE.md orientation map
...
- **Added** `contracts` — Require contract details at intake (#31)
...
- **Fixed** `events` — Clarify that the former Promoter/Artist fields identify the contract name and primary point of contact, distinct from the staff booker (#35)
...
- **Fixed** `reports` — Hide per-type Ticket Sales table on the Settlement Report when nothing sold in-house
- **Added** `reports` — Formal signable Settlement Report + fix door/outside-ticketing sales showing as 0
